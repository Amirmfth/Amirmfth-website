function Skills() {
  return (
    <section className="bg-light-gray dark:bg-dark-gray">
      ...
      >
        {/* Header */}
        <h2 className="text-2xl text-center font-semibold md:text-4xl">
          مهارت های من و ابزاری که استفاده میکنم
        </h2>
        {/* Skills container  */}
        <div
          data-aos="fade-up"
          className="w-full flex flex-col space-y-10 md:flex-row md:space-y-0 md:space-x-10 md:space-x-reverse"
        >
          ...
          <div className="flex flex-col space-y-10 md:w-1/2">
            ...
            >
              ...
              {/* Item 1 */}
              <div className="p-3 mb-3 ml-3 bg-light-gray text-black dark:bg-dark-gray dark:text-white rounded-xl">
                JS fundamentals
              </div>
              {/* Item 2 */}
              <div className="p-3 mb-3 ml-3 bg-light-gray text-black dark:bg-dark-gray dark:text-white rounded-xl">
