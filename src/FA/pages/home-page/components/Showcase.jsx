        ...
        <div className="flex flex-col items-center justify-center space-y-5 md:flex-row md:space-y-0 md:space-x-5 md:space-x-reverse">
          ...
          >
            ...
            <div className="flex flex-col pt-5 px-3 space-y-5 rounded-t-2xl duration-300 bg-white dark:bg-black md:h-48 md:group-hover:-translate-y-20">
              ...
              <h4 className="text-xl font-semibold">
                وبسایتی برای وبلاگ نویسان
              </h4>
              <p className="opacity-60">
                این وبسایت برای وبلاگ نویسان است. با رابط کاربری مینیمالیستی و
                استفاده از سرور سریع و قدرتمند، انتخاب بسیاری از وبلاگ نویسان
                است.
              </p>
              <a
          ...
          >
            ...
            <div className="flex flex-col  pt-5 px-3 space-y-5 rounded-t-2xl duration-300 bg-white dark:bg-black md:h-48 md:group-hover:-translate-y-20">
              ...
              <p className="opacity-60">
                یک تب جدید در مرورگر باز کنید و ببینید سایت های شما به سرعت لود
                میشوند. طراحی جذاب و UX ساده، این ابزار را به گزینه ای بهتر از
                سایر ابزار ها تبدیل میکند.
              </p>
              <a
        ...
        <div className="flex flex-col items-center justify-center space-y-5 md:flex-row md:space-y-0 md:space-x-5 md:space-x-reverse">
          ...
          >
            ...
            <div className="flex flex-col  pt-5 px-3 space-y-5 rounded-t-2xl duration-300 bg-white dark:bg-black md:h-48 md:group-hover:-translate-y-20">
              ...
              <p className="opacity-60">
                این برنامه کاربردی، نمایان گر یک وبسایت خرید واقعی با ویژگی های
                متعدد است. طراحی واضح و ساده یکی از مفاهیم کلیدی این وبسایت است.
              </p>
              <a
          ...
          >
            ...
            <div className="flex flex-col  pt-5 px-3 space-y-5 rounded-t-2xl duration-300 bg-white dark:bg-black md:h-48 md:group-hover:-translate-y-20">
              ...
              <p className="opacity-60">
                دسترسی به اخرین اطلاعات بازار ارز دیجیتال تنها با چند کلیک. حجم
                عظیم اطلاعات، چیزیست که این وبسایت را منحصر به فرد میکند.
              </p>
              <a
